...
const Header = () => {
    ...
    // tabs change
    const [iconClick, setIconClick] = useState({home:true, pages: false, vedio:false, market:false, group:false});
  ...
  return (
    <div className={darkMode?'header dark-parent':'header'}>
       ...
       <div className='header-middle'>
           <Tooltip
            title="Home">
                <div style={{borderBottom: (iconClick.home? '3px solid #0866ff': 'none')}} onClick={()=> handleTabChange("home")}>
                    {iconClick.home?
            ...
            <Tooltip title="Pages">
                <div style={{borderBottom: (iconClick.pages? '3px solid #0866ff': 'none')}} onClick={()=> handleTabChange("pages")}>
                    {iconClick.pages?
            ...
            <Tooltip title="Vedio">
                <div style={{borderBottom: (iconClick.vedio? '3px solid #0866ff': 'none')}} onClick={()=> handleTabChange("vedio")}>
                    {iconClick.vedio?
                    <svg viewBox="0 0 24 24" width="24" height="24" fill='#0866ff' >
            ...
            <Tooltip title="Marketplace">
                <div style={{borderBottom: (iconClick.market? '3px solid #0866ff': 'none')}} onClick={()=> handleTabChange("market")}>
                    {iconClick.market?
                        <svg viewBox="0 0 24 24" width="24" height="24" fill='#0866ff' >
            ...
            <Tooltip title="Groups">
                <div style={{borderBottom: (iconClick.group? '3px solid #0866ff': 'none')}} onClick={()=> handleTabChange("group")}>
                    {iconClick.group?
                        <svg viewBox="0 0 24 24" width="24" height="24" fill="#0866ff" >
