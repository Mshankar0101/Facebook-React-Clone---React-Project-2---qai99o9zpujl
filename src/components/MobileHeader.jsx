...
const MobileHeader = () => {
  ...
  return (
    <div style={{display:(location.pathname === '/login-signup' || location.pathname === '/search'?'none':location.pathname === '/menu'?'none':'block')}} className={darkMode?'dark-header-style header-mobile ':'header-mobile'}>
               ...
               <div className="pages">
                     <Tooltip title="Home">
                        <NavLink className='navlink' to='/'>
                            <div style={{borderBottom:(iconClick ==='home'?'3px solid #0866ff':'none')}} className='routes-div'>
                                {iconClick ==='home'?
                    ...
                    <Tooltip title="Pages">
                        <NavLink className='navlink' to='/pages'>
                            <div style={{borderBottom:(iconClick ==='pages'?'3px solid #0866ff':'none')}} className='routes-div' >
                                {iconClick==='pages'?
                    ...
                    <Tooltip title="Marketplace">
                        <NavLink className='navlink' to='/marketplace'>
                            <div style={{borderBottom:(iconClick ==='marketplace'?'3px solid #0866ff':'none')}} className='routes-div'>
                    ...
                    <Tooltip className='navlink' title="Groups">
                        <NavLink to='/groups'>
                            <div style={{borderBottom:(iconClick ==='groups'?'3px solid #0866ff':'none')}} className='routes-div'>
                                {iconClick === 'groups'?
                                    <svg viewBox="0 0 24 24" width="24" height="24" fill="#0866ff" >
